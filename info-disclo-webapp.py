#!/usr/bin/env python3
"""
Exposure Scan - single-file Flask web app (logo embedded)

This script:
 - Loads static/logo.png (if present) and encodes as base64
 - Embeds logo into HTML templates via data URI (ensures logo displays)
 - Provides full scanning UI + report + XLSX/ZIP export (same functionality as before)
...
<div class="container py-4">
  <div class="d-flex align-items-center mb-3 flex-wrap">
    ...
    {% endif %}
    <h1 class="mb-0">Exposure Scan</h1>
  </div>
